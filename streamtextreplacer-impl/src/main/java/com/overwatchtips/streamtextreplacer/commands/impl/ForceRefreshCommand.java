...
public class ForceRefreshCommand implements ConsoleCommand {

    private final StreamTextReplacer main;
    public ForceRefreshCommand(StreamTextReplacer main) {
        this.main = main;
    }

    @Override
    public void execute(String[] args) {
        StreamTextReplacer.getLogger().info("Forcing a placeholder refresh.");
        main.getPluginManager().refreshPlaceholders(true);
    }
}
